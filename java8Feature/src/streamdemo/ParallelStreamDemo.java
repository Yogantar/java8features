...
public class ParallelStreamDemo {
	...
	public static void main(String[] args) {
		...
		IntStream range = IntStream.rangeClosed(1, 20); //rangeClosed will also include the range values
//		range.forEach(System.out::println);
		range.forEach(i ->System.out.println(i + " -> Thread: "+ Thread.currentThread().getName()));
		
		System.out.println("******************* Parallel Stream ************");
		
		IntStream range2 = IntStream.rangeClosed(1, 20); //rangeClosed will also include the range values
