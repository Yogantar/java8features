...
public class StreamExample6 {
	...
	public static void main(String[] args) {
		...
		musicalInstruments.stream().forEach(i -> System.out.println(i)); // system.out::println
		System.out.println("");
		System.out.println("****************************************************************************");
		musicalInstruments.stream().forEach(i -> System.out.println(i.getName()+" "+ i.getType()+ " "+ i.getPrice())); // system.out::println
		...
		typeMap.forEach((key,value) -> {
			...
			value.forEach(System.out::println); //System.out.println(i.getName()+" "+ i.getType()+ " "+ i.getPrice())
		});
		System.out.println("");
